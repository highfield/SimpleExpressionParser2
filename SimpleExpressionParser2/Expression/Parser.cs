...
namespace Cet.Core.Expression
{
    internal static class Parser
    {
        ...
        internal static readonly IReadOnlyList<XToken> EmptyTokenList = new ReadOnlyCollection<XToken>(new XToken[0]);
        ...
        internal static XTreeNodeBase BuildTree(XToken token)
        {
            ...
            {
                var source = token.Data as IReadOnlyList<XToken> ?? EmptyTokenList;
